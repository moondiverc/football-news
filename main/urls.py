...
from main.views import show_main, create_news, show_news, register, login_user, logout_user, edit_news, delete_news, add_news_entry_ajax, show_xml, show_json, show_xml_by_id, show_json_by_id
